...
public class JMappedHeader extends JHeader
{
    ...
    private static class Entry
    {
         ...
         */
        public Entry(Object value, int offset, int length, String display, String description)
        {
            this.value = value;
            this.offset = offset;
            this.length = length;
    ...
    public String[] fieldArray()
    {
        ...
        Arrays.sort(r, new Comparator<String>()
        {
            ...
            {
                return fieldMap.get(o1).getOffset(JMappedHeader.this) - fieldMap.get(o2).getOffset(JMappedHeader.this);
            }
     ...
     * @param length the length
     */
    public void addField(Enum<? extends Enum<?>> field, String value, int offset, int length)
    {
        this.fieldMap.put(map(field), new Entry(value, offset, length, field.name(), null));
    }
