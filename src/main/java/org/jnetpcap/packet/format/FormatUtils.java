...
public class FormatUtils
{
     ...
     */
    public static String[] hexdump(byte[] array, int addressOffset, int dataOffset, boolean doAddress, boolean doText, boolean doData)
    {

        return hexdump(array, addressOffset, dataOffset, doAddress, doText, doData, null);
    }
     ...
     * @return converted string array, one array element per line of output
     */
    public static String[] hexdump(byte[] array, int addressOffset, int dataOffset, boolean doAddress, boolean doText, boolean doData, int[][] markers)
    {
        ...
        {
            multiLineStringList.add(hexLine(array, i + addressOffset, i + dataOffset, doAddress, doText, doData, markers));
        }
     ...
     */
    public static String hexdumpCombined(byte[] array, int addressOffset, int dataOffset, boolean doAddress, boolean doText, boolean doData)
    {

        return hexdumpCombined(array, addressOffset, dataOffset, doAddress, doText, doData, null);
    }
     ...
     * @return converted string
     */
    public static String hexdumpCombined(byte[] array, int addressOffset, int dataOffset, boolean doAddress, boolean doText, boolean doData, int[][] markers)
    {
        StringBuilder b = new StringBuilder();
        for (String s : hexdump(array, addressOffset, dataOffset, doAddress, doText, doData, markers))
        {
            b.append(s).append('\n');
        }
     ...
     * @return converted string array, one array element per line of output
     */
    public static String hexLine(byte[] array, int addressOffset, int dataOffset, boolean doAddress, boolean doText, boolean doData, int[][] markers)
    {
