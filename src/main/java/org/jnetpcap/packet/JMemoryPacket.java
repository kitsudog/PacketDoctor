...
public class JMemoryPacket extends JPacket
{
    ...
    /**
     * A capture header that stores information about the creation of the
     * packet.
     * 
     * @author Mark Bednarczyk
     * @author Sly Technologies, Inc.
    ...
    public static class JMemoryHeader implements JCaptureHeader
    {
         ...
         * 
         * @see
         * org.jnetpcap.JCaptureHeader#initFrom(org.jnetpcap.JCaptureHeader)
         */
        /**
         * Inits the from.
         * 
     ...
     * 
     * @param id numerical id of first protocol (DLT)
     * @param hexdump hexdump of the packet contents which will loaded into the
     *        raw data buffer
     */
     ...
     * performing a deep copy of the contents of the buffer into packet's
     * internal memory buffer if that buffer is large enough, otherwise a new
     * buffer is allocated. Both packet's state and data are then peered with
     * the internal buffer containing the copy of the supplied buffer
     * 
    ...
    /**
     * Creates a potentially uninitialized packet with the specified memory
     * type.
     * 
     ...
     * performed but the packet state and data are expected to be contained
     * within the buffer with a certain layout as described below:
     * <p>
     ...
     * </p>
     * 
     * @param buffer Buffer containing packet header, state and data. Position
     *        property specifies that start within the buffer where to peer the
     *        first byte.
     * @return number of bytes peered
     * @throws PeeringException thrown if ByteBuffer is not direct byte buffer
     *         type
     */
     ...
     * buffer. The layout of the buffer data will be as described below. A
     * buffer with this type of layout is suitable for any transferStateAndData
     * or peer methods for any buffers that are JMemory based. The buffer has to
