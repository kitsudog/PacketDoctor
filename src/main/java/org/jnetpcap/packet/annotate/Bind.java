...
public @interface Bind {
    ...
    public enum Type {
        ...
        /**
         * An optional binding type that provides heuristic discovery by
         * scanning potential header fields to make a best guess at what the
         * next header might be.
         */
        HEURISTIC
    }

    /**
     * (Optional) Constant value that can be used to bind one protocol to
     * another based on this value. The header specified using the "to"
     * parameter must supply methods or mark fields with <code>@BindValue</code>
     * annotation.
    ...
    /**
     * The protocol that wants to bind to another protocol. In the diagram below
     * B is binding to A. That is "to" == A.class. This is called the
     * <b>target</b> protocol.
     * <p>
     ...
     * <p>
     * In this example, <b>from</b> paramter is assigned to header <b>B
     * class</b>
     * 
     * <pre>
     * +----------+----------+----------------+ 
     ...
     * </pre>
     * 
     * Another words, <b>A header</b> is bind is bound <u>from</u> <b>B
     * header</b>
     * </p>
     * 
     ...
     * list is found within the packet for which binding is being evaluated
     * before actually checking the binding.
     * 
    ...
    /**
     * Specifies binding types. A binding can be assigned a different type,
     * which through <code>JRegistry</code> and <code>JScanner</code> operations
     * can be utilitized under special circumstances. For example
     ...
     * 
     * @return type of binding. The default binding type if none are specified
     *         is <code>Type.PRIMARY</code>
     */
