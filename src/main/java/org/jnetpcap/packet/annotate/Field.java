...
public @interface Field {
     ...
     * implicitely by using the name of the method. This parameter allows the
     * name of the field to be explicitely specified. The name of the field,
     * must be unique within the same header and acts as a unique ID of the
     * field.
     * 
    ...
    /**
     * Sets which bits within the field are significant. The mask is also used
     * in displaying bitfields, where each set bit is reported as significant
     * and non significant bits are skipped completely. Default is that all bits
     * within the length of the field are significant.
     * 
    ...
    /**
     * A priority this field is assigned which is used in determining which
     * field to include in output depending on what JFormat.Detail level the
     * user has selected. Default is <code>Priority.MEDIUM</code>.
     * 
