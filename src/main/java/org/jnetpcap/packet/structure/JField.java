...
public class JField
{
     ...
     */
    public static void sortFieldByOffset(JField[] fields, JHeader header, boolean ascending)
    {
    ...
    /**
     * If this field is a sub-field, this method returns a reference to the
     * parent field.
     * 
     * @return the parent
     */
    ...
    /**
     * Gets the current field's priority. Formatters determine if fields should
     * be included in the output based on priorities
     * 
     * @return the priority
     */
