...
public class AnnotatedField
{
    ...
    private static void checkSingature(Class<? extends JHeader> c, Method method)
    {
        ...
        {
            throw new AnnotatedMethodException(c, "missing @Field annotation on field " + method.getName());
        }
    }
     ...
     */
    public static AnnotatedField inspectEnumConstant(String field, Field enumAnnotation, Map<Property, AnnotatedFieldMethod> methods, Class<?> c)
    {

        if (methods.containsKey(Property.VALUE) == false)
        {
            throw new AnnotatedMethodException(c, "missing value getter method for field based on enum constant: " + field);
        }

        if (methods.containsKey(Property.LENGTH) == false)
        {
            throw new AnnotatedMethodException(c, "missing length getter method for field based on enum constant: " + field);
        }

        if (methods.containsKey(Property.OFFSET) == false)
        {
            throw new AnnotatedMethodException(c, "missing offset getter method for field based on enum constant: " + field);
        }
     ...
     * @return the annotated field
     */
    public static AnnotatedField inspectMethod(Class<? extends JHeader> c, Method m)
    {
     ...
     */
    public AnnotatedField(String name, Field enumAnnotation, Map<Property, AnnotatedFieldMethod> methods, Class<?> declaringClass)
    {
