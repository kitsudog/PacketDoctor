...
public class JBufferInputStream extends InputStream
{
     ...
     * @param length number of byte to read out of the buffer before signalining
     *        end of stream
     */
    public JBufferInputStream(JBuffer in, int offset, int length)
    {
        /*
         * Make sure the requested length is not bigger then our buffer. We
         * can't use max(), because position and end haven't been initialized
         * yet
         */
     ...
     * 
     * @return number of byte available in the buffer which is usually the
     *         entire buffer
     * @throws IOException Signals that an I/O exception has occurred.
     */
    @Override
     ...
     * @param off offset into the destination buffer where to store the block
     *        data
     ...
     * @return actual number of bytes skipped over. Can be less then requested
     *         if remaining number of bytes still to be read out of the source
     *         buffer was less then requested
     * @throws IOException Signals that an I/O exception has occurred.
     */
    @Override
    ...
    /**
     * Sets a mark within the buffer where subsequent reset operation will
     * revert back the position to.
     * 
     * @param readlimit Maximum number of bytes expected to be read. This
     *        parameter is ignored for source buffer operations since data does
     ...
     * read out of the buffer, then this method returns just the available
     * length.
     * 
