...
public class JBuffer extends JMemory
{
     ...
     * 
     * @param index offset into the buffer
     * @param array byte array used to store the result where the length of the
     *        byte array determines the number of bytes to be copied from the
     *        buffer
    ...
    /**
     * Gets the byte data from buffer and stores into newly allocated byte
     * array.
     * 
     * @param index offset into the buffer
     * @param size number of bytes to copy and the size of the newly allocated
     *        byte array
    ...
    public byte[] getByteArray(int index, byte[] array, int offset, int length)
    {
        ...
        return getByteArray0(physical, check(index, length, physical), array, array.length, offset, length);
    }
     ...
     */
    private static native byte[] getByteArray0(long address, int index, byte[] array, int arrayLength, int offset, int length);
     ...
     * 
     * @param index offset into the buffer
     * @param buf string buffer where to store the string retrieved from the
     *        buffer
    ...
    /**
     * Gets the byte-order of this buffer. The buffer allows big and little
     * endian byte ordering of the integer values accessed by this buffer.
     * 
    ...
    /**
     * Peers this buffer with a new buffer. The peer buffer's properties
     * position and limit are used as starting and ending offsets for the peer
     * operation.
     * 
     ...
     * @return number of bytes peered
     * @throws IndexOutOfBoundsException if offset and/or length are out of
     *         bounds
     */
     ...
     * 
     * @param index offset into the buffer
     * @param array Array containing data to be set within the buffer. The
     *        length of the buffer determines the number of bytes to be copied
     *        into the buffer.
     */
    public void setByteArray(int index, byte[] array)
    {
        setByteArray0(physical, check(index, array.length, physical), array, array.length);
    }
     ...
     * @param arrayLength the array length
     */
    private static native void setByteArray0(long address, int index, byte[] array, int arrayLength);
     ...
     * @param value the value
     */
    private static native void setDouble0(long address, boolean order, int index, double value);
     ...
     * @param value the value
     */
    private static native void setFloat0(long address, boolean order, int index, float value);
     ...
     * @param value the value
     */
    private static native void setInt0(long address, boolean order, int index, int value);
     ...
     * @param value the value
     */
    private static native void setLong0(long address, boolean order, int index, long value);
     ...
     * @param value the value
     */
    public static native void setShort0(long address, boolean order, int index, short value);
     ...
     * @param value the value
     */
    private static native void setUInt0(long address, boolean order, int index, long value);
     ...
     * @param value the value
     */
    private static native void setUShort0(long address, boolean order, int index, int value);

    /**
     * Copies contents of the supplied buffer into this buffer.
     * 
     * @param buffer Source buffer to copy from. The array length determines the
     ...
     * Copies contents of the supplied buffer into this buffer.
     * 
     * @param src Source buffer to copy from. The position and limit properties
     *        of the buffer determine the bounds of the copy.
     ...
     * Copies contents of the supplied buffer into this buffer.
     * 
     * @param buffer Source buffer. The length of the source buffer determines
     ...
     * 
     * @param dst Destination buffer where to copy to. The number of bytes
     *        copied is determined by the size of source buffer.
     * @return number of bytes copied
     */
     ...
     * @param length number of bytes to copy
     * @param dstOffset offset into the destination buffer where to start copy
     *        to
     * @return number of bytes copied
     */
    @Override
    ...
    /**
     * Sets this buffer as either read-only or read-write. Read-only mode
     * disables all mutable operations on this buffer.
     * 
     ...
     * @param data data to copy into this buffer. The position and limit of the
     *        data buffer set the bounds of the copy
     */
    public native void setByteBuffer(int index, ByteBuffer data);

    /**
     * Peers this object with the supplied object. This object will be pointing
     * at the same memory as the supplied object.
     * 
     * @param src source object that holds the memory location and size this
