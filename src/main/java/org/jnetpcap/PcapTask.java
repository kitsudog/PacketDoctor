...
public abstract class PcapTask<T> implements Runnable
{
     ...
     * method.
     * 
     * @throws InterruptedException if the synchronization between threads was
     *         interrupted
     */
    ...
    /**
     * <p>
     * Terminates the task after making sure that the pcap session and thread
     * are active.
     * </p>
     * 
     * @throws InterruptedException since this method waits for the background
     *         thread to terminate, it can be interrupted
     */
    ...
    /**
     * Algorithm for breaking the loop, whatever it is. It can be overriden and
     * a different algorithm supplied.
     */
