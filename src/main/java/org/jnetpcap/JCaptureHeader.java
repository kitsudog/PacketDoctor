 ...
 * <code>PcapHeader</code>, the capture header provided by libpcap, implements
 * this interface which provides access to minimum set of information about the
 * capture packet.
 * 
...
public interface JCaptureHeader
{
     ...
     * Pcap.openXXX call. If the packet was not trucated, this length should
     * equal the length returned by {@link #wirelen()}.
     * 
     ...
     * they are converted to nano seconds. For example of the capture timestamp
     * is in micro seconds, then the micro seconds fraction is multiplied by a
     * 1000 before being returned to conform to nano second return timestamp.
     * 
     * @return Number of nano seconds at the time of the packet capture. The
     *         valid value returned by this method is from 0 to 999,999,999.
     */
    public abstract long nanos();

    /**
     * Converts the timestamp into a java style timestamp suitable for usage
     * with <code>Date</code> class.
     * 
