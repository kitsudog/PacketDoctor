...
public class Ip4 extends JHeaderMap<Ip4> implements JHeaderChecksum
{
    ...
    public enum Ip4Type implements JHeaderType {
        ...
        /**
         * Transport Layer Security Protocol [Oberg] using Kryptonet key
         * management.
         */
    ...
    public static abstract class IpOption extends JSubHeader<Ip4>
    {
        ...
        /**
         * Gets the Ip4.code field. Specifies the optional header type. <h3>
         * Header Spec</h3>
         * <table border=1>
         * <tr>
        ...
        /**
         * Sets the Ip4.code field. Specifies the optional header type. <h3>
         * Header Spec</h3>
         * <table border=1>
         * <tr>
         * <td>Protocol Header:</td>
     ...
     * integer. The value returned should be treated as an unsigned integer,
     * which java can not represent as an int. If neccessary to printout the
     * value returned, in order to correctly represent the unsinged value, the
     * integer returned should be converted to a java long type and sign
     * appropriately handled to take advantage of the extra length of a java
     * long type.
     * 
     ...
     * that has each Ip4 flag encoded as a bit field. The first flag is encoded
     * in bit number 0 of the returned usigned integer.
     * 
    ...
    public String hlenDescription()
    {
        ...
        return (hlen() == 5) ? pre + ", No Ip Options" : pre + ", Ip Options Present";
    }
    ...
    /**
     * Checks if this is ip fragment of a larger PDU. The method checks offset
     * and flags.MF fields to see if there are other fragments, marked by flags
     * and offset, for a larger PDU.
     * 
    ...
    public String offsetDescription()
    {
        return (offset() == 0) ? null : "" + offset() + " * 8 = " + (offset() * 8) + " bytes";
    }
     ...
     * The value returned should be treated as an unsigned integer, which java
     * can not represent as an int. If neccessary to printout the value
    ...
    public String typeDescription()
    {
        ...
        return (offset() == 0) ? "next: " + next : "ip fragment" + (next == null ? "" : " of " + next + " PDU");
    }
