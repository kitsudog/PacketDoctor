...
public class Tcp extends JHeaderMap<Tcp> implements JHeaderChecksum
{
    ...
    public enum Flag {
         ...
         * All packets after the initial SYN packet sent by the client should
         * have this flag set.
         */
        ACK,
        /**
         ...
         * flag set and had responded in congestion control mechanism (added to
         * header by RFC 3168).
         */
        CWR,
        /**
         ...
         * normal transmission (added to header by RFC 3168).
         */
        ECE,
    ...
    public static class SACK extends TcpOption
    {
        ...
        {
            final int count = (array.length < blockCount() * 2) ? array.length : blockCount() * 2;
    ...
    public int calculateChecksum()
    {
        ...
        return Checksum.inChecksumShouldBe(checksum(), Checksum.pseudoTcp(this.packet, ipOffset, getOffset()));
    }
