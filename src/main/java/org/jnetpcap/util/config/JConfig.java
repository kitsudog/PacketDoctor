 ...
 * <ul>
 * <li>{@value #CACHE_DIR_PROPERTY} - property defines full directory name where
 * resolver files are saved
...
public class JConfig
{
    ...
    protected static class ClasspathSearch implements SearchPath
    {
         ...
         * 
         * @see
         * org.jnetpcap.util.config.JConfig.SearchPath#getDir(java.lang.String)
         */
        /**
         * Gets the file.
         * 
    ...
    private static class CompositeProperties extends Properties
    {
         ...
         * @param in the in
         * @throws IOException Signals that an I/O exception has occurred.
         * @throws InvalidPropertiesFormatException the invalid properties
         *         format exception
         * @see java.util.Properties#loadFromXML(java.io.InputStream)
         */
        @Override
        ...
        public InputStream getInputStream(String name) throws IOException
        {
            ...
            if (url.expand(name, globalVariables, topReadOnlyProperties))
            {
                ...
                catch (IOException e)
                {
                    ...
                    /*
                     * For debug purposes, we rebuild from template by
                     * explanding just the variables and leaving the property
                     * names unexpanded. The full template string is hard to
                     * understand when the variables aren't expanded.
                     */
    ...
    /**
     * We initialize configuration within static initializer because the order
     * of initialization is really important and thus has to be initialized from
     * here.
     */
    static
    {
        ...
        /*
         * Step #1 - logger comes from 1.5 JRE, shouldn't provide any
         * exceptions. This is the reason we don't use JLogger in this static
         * initializer
         */
        ...
        /*
         * Now create properties object we can modify. This is the object that
         * will be saved and use for user defined config.properties if found. We
         * create an empty one here so we can build the composite with the right
         * evaluation order.
         */
        ...
        /*
         * Now search for user defined config properites. Property name looked
         * up is "config.name". We need name so we can look for this specific
         * resource in the entire search path.
         */
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    /*
                     * No need to reinitialize, JLogger already initialized to
                     * builtins.
                     */
