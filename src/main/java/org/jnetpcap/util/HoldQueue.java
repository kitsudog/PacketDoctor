...
public class HoldQueue<T, C> extends AbstractQueue<T> implements Queue<T>
{
    ...
    /** The handles. */
    private final PriorityQueue<HoldHandle<C>> handles = new PriorityQueue<HoldHandle<C>>();
     ...
     */
    protected HoldQueue(final Queue<T> hidden, final Queue<T> exposed, Comparator<T> comparator)
    {
