...
public class SlidingBuffer
{
    ...
    public SlidingBuffer(int size)
    {
        ...
        /*
         * Allocate round robin buffer with padding so that we can duplicate a
         * few bytes at the right edge of the real offset. This way if we're
         * asked to read a value that is wrapped around mid way at the end of
         * the buffer, we can just safely read it since those bytes have been
         * duplicated.
         */
