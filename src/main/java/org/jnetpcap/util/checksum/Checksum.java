...
public class Checksum
{
     ...
     * @return calculated crc
     */
    public static int crc16CCITTContinue(JBuffer buffer, int offset, int length, int crc)
    {
     ...
     * @return calculated crc
     */
    public static native int crc16CCITTSeed(JBuffer buffer, int offset, int length, int seed);
     ...
     * @return calculated crc
     */
    public static native int crc32c(JBuffer buffer, int offset, int length, int crc);
     ...
     * @return calculated crc
     */
    public static int crc32CCITTContinue(JBuffer buffer, int offset, int length, int crc)
    {
     ...
     * @return calculated crc
     */
    public static native int crc32CCITTSeed(JBuffer buffer, int offset, int length, int seed);
    ...
    {
        return ((c >> 0 & 0xFF) << 24) | ((c >> 8 & 0xFF) << 16) | ((c >> 16 & 0xFF) << 8) | ((c >> 24 & 0xFF) << 0);
    }
     ...
     */
    public static native int inChecksumShouldBe(int checksum, int calculateChecksum);
