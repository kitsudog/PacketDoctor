...
{
    /**
     * Type of resolver that can be registered with JRegistry. Resolvers job is
     * to convert a binary number to a human readable name associated with it.
     * For example IP resolver will convert ip address to hostnames.
     * 
     * @author Mark Bednarczyk
     * @author Sly Technologies, Inc.
     */
     ...
     * retrieved from the url is resolver specified. The default cache file
     * format is attempted at some point in the file scan until the file can be
     * read or the load fails.
     * 
     ...
     * @throws IOException any IO errors during save
     */
